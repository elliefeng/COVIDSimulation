	...
	*/
	public abstract class Structure extends JPanel implements ActionListener{
	    ...
	    public Structure(Control ctl, String title) {
	    ...
	    /* paint walls method for painting the walls of the structure */
